...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("rtl_key", 32, hls_in, 0, "ap_none", "in_data", 1),
	Port_Property("br_key", 32, hls_in, 1, "ap_none", "in_data", 1),
	Port_Property("dp_key", 32, hls_in, 2, "ap_none", "in_data", 1),
